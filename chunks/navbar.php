<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">K L O T H - S T O R E</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">Store</i></a>
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="foods.php" class="hvr-grow">New Arrivals</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91XXXXXXXXX. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
	        ...
	        <li><a href="foods.php">New Arrivals</a></li>
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91XXXXXXXX. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
